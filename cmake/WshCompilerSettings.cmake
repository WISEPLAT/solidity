#------------------------------------------------------------------------------
# WshCompilerSettings.cmake
#
# CMake file for cpp-wiseplat project which specifies our compiler settings
# for each supported platform and build configuration.
#
# The documentation for cpp-wiseplat is hosted at http://cpp-wiseplat.org
#
# Copyright (c) 2014-2016 cpp-wiseplat contributors.
#------------------------------------------------------------------------------
...
include(WshCheckCXXCompilerFlag)

wsh_add_cxx_compiler_flag_if_supported(-fstack-protector-strong have_stack_protector_strong_support)
if(NOT have_stack_protector_strong_support)
	wsh_add_cxx_compiler_flag_if_supported(-fstack-protector)
endif()

wsh_add_cxx_compiler_flag_if_supported(-Wimplicit-fallthrough)
...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	#     https://github.com/wiseplat/webthree-umbrella/issues/384
	#     https://github.com/wiseplat/webthree-helpers/pull/170
	#
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-O0 -g -DWSH_DEBUG")
	...
	elseif ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
		...
		if (EMSCRIPTEN)
			...
			add_definitions(-DWSH_EMSCRIPTEN=1)
		endif()
	endif()
...
if (PROFILING AND (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")))
	...
	add_definitions(-DWSH_PROFILING_GPERF)
