...
can try `Remix <https://remix.wiseplat.org/>`_
which does not need any installation. If you want to use it
without connection to the Internet, you can go to
https://github.com/wiseplat/browser-solidity/tree/gh-pages and
...
Please refer to the `solc-js <https://github.com/wiseplat/solc-js>`_ repository for instructions.
...
.. note::
    ...
    The comandline options of `solcjs` are not compatible with `solc` and tools (such as `gwsh`)
...
.. code:: bash
    ...
    docker run wiseplat/solc:stable solc --version
...
`solidity/releases <https://github.com/wiseplat/solidity/releases>`_.

We also have PPAs for Ubuntu.  For the latest stable version.

.. code:: bash

    sudo add-apt-repository ppa:wiseplat/wiseplat
    sudo apt-get update
...
.. code:: bash
    ...
    sudo add-apt-repository ppa:wiseplat/wiseplat
    sudo add-apt-repository ppa:wiseplat/wiseplat-dev
    sudo apt-get update
    sudo apt-get install solc
...
View 
`solidity.rb commits on Github <https://github.com/wiseplat/homebrew-wiseplat/commits/master/solidity.rb>`_.
...
.. code:: bash
    ...
    # Install 0.4.8
    brew install https://raw.githubusercontent.com/wiseplat/homebrew-wiseplat/77cce03da9f289e5a3ffe579840d3c5dc0a62717/solidity.rb
...
.. code:: bash
    ...
    git clone --recursive https://github.com/wiseplat/solidity.git
    cd solidity
