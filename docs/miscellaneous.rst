...
- ``keccak256(...) returns (bytes32)``: compute the Wiseplat-SHA-3 (Keccak-256) hash of the :ref:`(tightly packed) arguments <abi_packed_mode>`
...
- ``payable`` for functions: Allows them to receive Wise together with a call.
