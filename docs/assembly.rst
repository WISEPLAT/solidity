...
.. warning::
    Inline assembly is a way to access the Wiseplat Virtual Machine
...
This document does not want to be a full description of the Wiseplat virtual machine, but the
