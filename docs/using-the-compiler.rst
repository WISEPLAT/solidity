...
::
    ...
    solc github.com/wiseplat/dapp-bin/=/usr/local/lib/dapp-bin/ =/usr/local/lib/fallback file.sol

This essentially instructs the compiler to search for anything starting with
``github.com/wiseplat/dapp-bin/`` under ``/usr/local/lib/dapp-bin`` and if it does not
...

    {
      ...
      contracts: {
        "sourceFile.sol": {
          ...
          "ContractName": {
            // The Wiseplat Contract ABI. If empty, it is represented as an empty array.
            // See https://github.com/wiseplat/wiki/wiki/Wiseplat-Contract-ABI
            abi: [],
