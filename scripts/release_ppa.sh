...
## and uploads it to the wiseplat/wiseplat-dev ppa.
##
## If an argument is given, it is used as a tag and the resulting package
## is uploaded to the wiseplat/wiseplat ppa.
##
## The gnupg key for "builds@wiseplat.org" has to be present in order to sign
## the package.
##
...
##  method			= ftp
##  incoming		= ~wiseplat/wiseplat-dev
##  login			= anonymous
## 
##  [wiseplat]
##  fqdn			= ppa.launchpad.net
##  method			= ftp
##  incoming		= ~wiseplat/wiseplat
##  login			= anonymous
...
if [ "$branch" = develop ]
then
    pparepo=wiseplat-dev
    ppafilesurl=https://launchpad.net/~wiseplat/+archive/ubuntu/wiseplat-dev/+files
else
    pparepo=wiseplat
    ppafilesurl=https://launchpad.net/~wiseplat/+archive/ubuntu/wiseplat/+files
fi

keyid=703F83D0
email=builds@wiseplat.org
packagename=solc
...
# Fetch source
git clone --depth 2 --recursive https://github.com/wiseplat/solidity.git -b "$branch"
mv solidity solc
...
Section: science
Priority: extra
Maintainer: Christian (Buildserver key) <builds@wiseplat.org>
...
Vcs-Git: git://github.com/wiseplat/solidity.git
Vcs-Browser: https://github.com/wiseplat/solidity
...
Upstream-Name: solc
Source: https://github.com/wiseplat/solidity

Files: *
Copyright: 2014-2016 Wiseplat
License: GPL-3.0+

Files: debian/*
Copyright: 2016 Wiseplat
License: GPL-3.0+
...
solc (0.0.1-0ubuntu1) saucy; urgency=low
 ...
 -- Christian <build@wiseplat.org>  Mon, 03 Feb 2016 14:50:20 +0000
EOF
