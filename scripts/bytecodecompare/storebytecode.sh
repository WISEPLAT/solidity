...
# uploads the bytecode into github.com/wiseplat/solidity-test-bytecode where
...
EOF
    ...
    then
        ...
        git clone --depth 2 git@github.com:wiseplat/solidity-test-bytecode.git
        cd solidity-test-bytecode
        git config user.name "travis"
        git config user.email "chris@wiseplat.org"
        git clean -f -d -x
