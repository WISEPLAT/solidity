...
void dev::wsh::killBigints(sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::wsh::debugOutAST(ostream& _out, sp::utree const& _this)
{
	switch (_this.which())
	{
...
void dev::wsh::parseTreeLLL(string const& _s, sp::utree& o_out)
{
	using qi::standard::space;
	using qi::standard::space_type;
	using dev::wsh::parseTreeLLL_::tagNode;
