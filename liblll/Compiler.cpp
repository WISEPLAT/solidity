...
bytes dev::wsh::compileLLL(string const& _src, bool _opt, vector<string>* _errors, ReadCallback const& _readFile)
{
	try
	{
		CompilerState cs;
...
std::string dev::wsh::compileLLLToAsm(std::string const& _src, bool _opt, std::vector<std::string>* _errors, ReadCallback const& _readFile)
{
	try
	{
		CompilerState cs;
...
string dev::wsh::parseLLL(string const& _src)
{
	sp::utree o;
