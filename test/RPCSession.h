...
public:
	...
	std::string wsh_getCode(std::string const& _address, std::string const& _blockNumber);
	Json::Value wsh_getBlockByNumber(std::string const& _blockNumber, bool _fullObjects);
	std::string wsh_call(TransactionData const& _td, std::string const& _blockNumber);
	TransactionReceipt wsh_getTransactionReceipt(std::string const& _transactionHash);
	std::string wsh_sendTransaction(TransactionData const& _td);
	std::string wsh_sendTransaction(std::string const& _transaction);
	std::string wsh_getBalance(std::string const& _address, std::string const& _blockNumber);
	std::string wsh_getStorageRoot(std::string const& _address, std::string const& _blockNumber);
