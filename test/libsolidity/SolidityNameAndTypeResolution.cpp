...
{
	// test for issue #1126 https://github.com/wiseplat/cpp-wiseplat/issues/1126
	char const* text = R"(
		contract Parent {
...
BOOST_AUTO_TEST_CASE(overflow_caused_by_wise_units)
{
	...
	char const* sourceCode = R"(
		contract c {
			function c () public {
				 a = 115792089237316195423570985008687907853269984665640564039458 wise;
			}
			uint256 a;
		}
	)";
...
{
       // bug #1798 (cpp-wiseplat), related to #1286 (solidity)
       char const* text = R"(
               contract attribute {
                       bool ok = false;
               }
