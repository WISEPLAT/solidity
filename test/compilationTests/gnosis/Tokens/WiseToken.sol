...
/// @title Token contract - Token exchanging Wise 1:1
/// @author Stefan George - <stefan@gnosis.pm>
contract WiseToken is StandardToken {
    using Math for *;
     ...
     *  Constants
     */
    string public constant name = "Wise Token";
     ...
     *  Public functions
     */
    /// @dev Buys tokens with Wise, exchanging them 1:1
    function deposit()
        public
        payable
    {
    ...
    /// @dev Sells tokens in exchange for Wise, exchanging them 1:1
