...
private:
	...
	void initializeContext(
		ContractDefinition const& _contract,
		std::map<ContractDefinition const*, wsh::Assembly const*> const& _compiledContracts
	);
	...
	static wsh::AssemblyPointer cloneRuntime();

	bool const m_optimise;
	/// Pointer to the runtime compiler in case this is a creation compiler.
	ContractCompiler* m_runtimeCompiler = nullptr;
	CompilerContext& m_context;
	std::vector<wsh::AssemblyItem> m_breakTags; ///< tag to jump to for a "break" statement
	std::vector<wsh::AssemblyItem> m_continueTags; ///< tag to jump to for a "continue" statement
	/// Tag to jump to for a "return" statement, needs to be stacked because of modifiers.
	std::vector<wsh::AssemblyItem> m_returnTags;
