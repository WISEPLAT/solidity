...
class WshAssemblyAdapter: public julia::AbstractAssembly
{
public:
	explicit WshAssemblyAdapter(wsh::Assembly& _assembly):
	...
	{
		m_assembly.append(wsh::AssemblyItem(wsh::Tag, _labelId));
	}
	/// Append a label reference.
	virtual void appendLabelReference(LabelID _labelId) override
	{
		m_assembly.append(wsh::AssemblyItem(wsh::PushTag, _labelId));
	}
...
private:
	static LabelID assemblyTagToIdentifier(wsh::AssemblyItem const& _tag)
	{
		u256 id = _tag.data();
	...
	wsh::Assembly& m_assembly;
};

void assembly::CodeGenerator::assemble(
	Block const& _parsedData,
	AsmAnalysisInfo& _analysisInfo,
	wsh::Assembly& _assembly,
	julia::ExternalIdentifierAccess const& _identifierAccess,
	bool _useNamedLabelsForFunctions
)
{
	WshAssemblyAdapter assemblyAdapter(_assembly);
	julia::CodeTransform(
		assemblyAdapter,
		_analysisInfo,
		false,
