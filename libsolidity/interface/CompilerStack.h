...
public:
	...
	wsh::LinkerObject const& object(std::string const& _contractName = "") const;

	/// @returns the runtime object for the contract.
	wsh::LinkerObject const& runtimeObject(std::string const& _contractName = "") const;
	...
	wsh::LinkerObject const& cloneObject(std::string const& _contractName = "") const;

	/// @returns normal contract assembly items
	wsh::AssemblyItems const* assemblyItems(std::string const& _contractName = "") const;

	/// @returns runtime contract assembly items
	wsh::AssemblyItems const* runtimeAssemblyItems(std::string const& _contractName = "") const;
...
private:
	...
	struct Contract
	{
		...
		wsh::LinkerObject object;
		wsh::LinkerObject runtimeObject;
		wsh::LinkerObject cloneObject;
	...
	void compileContract(
		...
		std::map<ContractDefinition const*, wsh::Assembly const*>& _compiledContracts
	);
	void link();
	...
	std::string computeSourceMapping(wsh::AssemblyItems const& _items) const;
	...
	/// list of path prefix remappings, e.g. mylibrary: github.com/wiseplat = /usr/local/wiseplat
