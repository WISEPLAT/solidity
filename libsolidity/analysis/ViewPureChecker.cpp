...
public:
	...
	{
		if (wsh::SemanticInformation::invalidInViewFunctions(_instruction.instruction))
			m_reportMutability(StateMutability::NonPayable, _instruction.location);
		else if (wsh::SemanticInformation::invalidInPureFunctions(_instruction.instruction))
